...
from aicsmlsegment.model_utils import load_checkpoint, model_inference, save_checkpoint
from aicsmlsegment.custom_metrics import MeanIoU, DiceCoefficient, AveragePrecision
...
def get_loss_criterion(config):
    ...
    assert name in SUPPORTED_LOSSES, (
